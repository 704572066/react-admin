...
@ApiBearerAuth()
@Controller('ai-console/gpt-app-management')
export class GPTAppManagementController {
  ...
  async getUserList(@Query() userInfo: ListAppManagementDto) {
    const response = await this.appManagementService.getAppList(userInfo);
    return response;
  }
  ...
  async createUser(
    ...
    const response = await this.appManagementService.createUser(
      userInfo,
      session,
    );
    return response;
  ...
  async updateUser(
    ...
    const response = await this.appManagementService.updateUser(
      user_id,
      userInfo,
      session,
    );
  ...
  async deleteUser(@Param('user_id') user_id: string) {
    const response = await this.appManagementService.deleteUser(user_id);
    return response;
  }
  ...
  async updateUserStatus(
    ...
    const response = await this.appManagementService.updateUserStatus(
      user_id,
      status,
    );
    return response;
