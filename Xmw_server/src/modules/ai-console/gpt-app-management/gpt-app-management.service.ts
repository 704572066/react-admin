...
import { ListAppManagementDto, SaveUserManagementDto } from './dto';
...
export class AppManagementService {
  ...
  async getAppList(
    ...
    const appsRaw = await this.prismaService.apps.findMany({skip:start, take:end-start,orderBy:{
      [sort] :"asc" 
    }})
      // .skip(start)
      // .limit(end - start)
    ...
    const totalCount = await this.prismaService.apps.count();
